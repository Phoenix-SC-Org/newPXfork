...
const DYNAMIC_KEYS = new Set([
    ...
    // Phase 9 (Government/Wiki): Regierungstypen/-vorlagen, Tab-Labels, Order-/Motion-Status, Wahlsysteme, Fill-Methods
    "Military Junta",
    "Corporate Board",
    "Democratic Republic",
    ...
    "Legislative",
    "Judicial",
    "Supreme commander with an appointed advisory council. Direct chain of command.",
    "CEO leads the executive. Board of Directors elected by members.",
    "Elected President, Senate legislature, and appointed judiciary.",
    "Hereditary monarch with an elected parliament.",
    "Bicameral parliament with PM elected by the house. Proportional representation.",
    "Merit-based council of experts. Competence over popularity.",
    "Captain elected by the crew. Quartermaster keeps order.",
    "Start from scratch. Build your own branches and positions.",
    "Simple Majority",
    "Preferential (IRV)",
    "Proportional",
    "Approval",
    ...
    // Phase 10 (Restbestand): Timeline-/Filter-Labels, Datumsformat-Presets, Suchtypen, Audience-Configs, bulk-verbs, authError-Sentinels
    "Awards",
    "Certification Awarded",
    "Commendation Awarded",
    "Compact (DD MMM YY hh:mm AM/PM)",
    "ISO (YYYY-MM-DD HH:mm)",
    "US (MMM D, YYYY hh:mm AM/PM)",
    "German (DD MM YY HH:MM 24h)",
    "Unit Channels",
    "Frequencies",
    "Application",
    "specialization",
    ...
    "commendations",
    "Client Dashboard",
    "All logged in clients can see this notice.",
    "Members Dashboard",
    "All logged in members can see this notice.",
    "Admins Only",
    "All logged in admins will see this notice on the dashboard and other views.",
    "Login Screen",
    "Shown on the login screen for all visitors.",
    "Planet",
    "Moon",
    "Facility",
    ...
    "New responder added to your mission",
    "Responder removed from your request",
    "Teammate removed from your mission",
    "Granted",
    "Demoted",
    "Discord sign-in did not complete — it may have been cancelled, or the redirect URL is not registered in your Discord app. Please try again.",
    "Sign-in could not be verified — your session may have expired or the page reloaded mid-login. Please try signing in again.",
    "Authentication failed. Please try again, or contact the org admin if this persists.",
    // Phase 11 (Admin): Nav-Labels/-Gruppen, Permission-Kategorien+Beschreibungen, Katalog-Flags/-Specs, Enum-Kontexte
    "With Images",
    "User References",
    "No External UUID",
    "Vehicle",
    ...
    "EVERY treasury account, ledger entry, deposit, withdrawal, transfer, payout, adjustment, and reversal",
    "EVERY catalog item (custom only), location, inventory row, movement, and issuance — past and present",
    "WARNING",
    "ERROR",
    "Closed Caution Notes",
    "Concluded Ops",
    ...
    "Joint Ops",
    "Sync Cautions",
    "Generate reports from caution notes",
    "Feed Ingest",
    "Pull from allied feeds",
    "Dedup Cautions",
    "Remove duplicate caution notes",
    "Dedup Intel",
    ...
    "Manage Branding & System Config",
    "Manage Discord Integration",
    "Manage SEO & Metadata",
    "Manage AI Configuration",
    "Manage API Keys",
    "Manage External Tools",
    "Manage Global Catalog (Ships/Items/Commodities/Locations)",
    "Destroy all data (full reset / full wipe)",
    ...
    "View User History",
    "Add/Remove Conduct Entries",
    "Add/View Personnel Notes",
    "Toggle Duty Status",
    "Award Certification",
    ...
    "Manage Documents",
    "View Intelligence Hub & Post Bulletins",
    "View Classified Intel Reports",
    "Create Formal Intelligence Reports",
    "Manage & Delete Intel Reports/Bulletins",
    "View Warrants",
    "Issue Warrants",
    "Manage Warrants",
    ...
    "Manage Own Profile",
    "Manage Own Unit",
    "View All Restricted Units",
    "Manage Client UI Settings",
    "Receive EAM Alerts",
    "View Fleet Manager",
    "Manage Own Ship Hangar",
    "Manage Fleet Groups & Assignments",
    "View Alliance Directory",
    "Manage Alliances & Directory Profile",
    "View Org Wiki",
    "Create Wiki Pages",
    "Edit Wiki Pages & Settings",
    "Delete Wiki Pages",
    "View Government",
    "Vote & Run for Office",
    "Propose/Vote on Legislation",
    "Manage Elections",
    "Manage Governance",
    "Configure Government Structure",
    "Issue Executive Orders",
    "Toggle Optional Features",
    "View Org Finances",
    "Submit Deposit Claims",
    "Request Withdrawals",
    "Approve / Reject Pending Entries",
    "Manage Accounts, Adjustments, Reversals",
    "Configure Finances Module",
    "View Org Armoury",
    "Request Issuance of Items",
    "Manage Inventory & Issuances",
    "Configure Catalog, Locations, Module",
    "View Org Warehouse",
    "Request Withdrawal of Bulk Stock",
    "Manage Stock, Transfers & Withdrawals",
    "Configure Commodity Catalog",
    "Browse the Marketplace",
    "Post & Manage Own Listings",
    "Propose & Fulfil Contracts",
    "Moderate Marketplace & Reports",
    "Channel Settings",
    "Role Mapping",
    "Existing pages with the same slug are left alone. New pages are added.",
    "Existing pages are replaced with the imported version. Destructive.",
    "Every imported page becomes a new row. Slugs collide-suffix as needed.",
    "Reviewing",
    "Actioned",
    "Dismissed",
    "listing",
